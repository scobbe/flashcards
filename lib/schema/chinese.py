    ...
    PromptField(
        ...
        prompt={
            "single_char": _join([
                ...
                'For CONTRACTIONS: if Wiktionary says a component is a "contraction of X", explain this relationship',
                'E.g. 古: 十 (contraction of 盾(盾) (dùn, "shield")) + 口(口) (kǒu, "mouth") = strong/firm like a shield -> original form of 固(固) (gù, "solid")',
                'CRITICAL: Do NOT give a component its standalone meaning if Wiktionary says it is a contraction of something else',
    ...
    PromptField(
        ...
        prompt={
            "single_char": _join([
                ...
                "CRITICAL: If description mentions 'Y (contraction of X)' -> BOTH Y and X must be in parts",
                "E.g. 古: description has '十 (contraction of 盾)' -> parts MUST include BOTH 十 AND 盾",
                "E.g. 古: full description '十 (contraction of 盾) + 口 = original form of 固' -> parts = [十, 盾, 口, 固] (all 4 characters)",
                "RULE: parts = EVERY character referenced in YOUR description/interpretation - no exceptions except 'compare to' contrasts",
                "CRITICAL: 'english' field MUST ALWAYS contain the component's OWN standalone definition - NEVER 'None' or empty",
                "Even if a component is purely phonetic and doesn't contribute meaning, still provide its actual definition",
                "E.g. 臼 in 舅 is phonetic only, but english should be \"mortar\" (臼's own meaning), NOT \"None\"",
            ]),
            "multi_char": _join([
                ...
                "CRITICAL: 'english' field MUST ALWAYS contain the morpheme's definition - NEVER 'None' or empty",
            ]),
        },
        response_type="list",
    ),
